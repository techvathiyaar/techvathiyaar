...
export default {
  ...
  "organizationName": "techvathiyaar",
  "projectName": "techvathiyaar",
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/workspaces/techvathiyaar/techvathiyaar/sidebars.js",
        ...
        "theme": {
          "customCss": "/workspaces/techvathiyaar/techvathiyaar/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    "image": "img/tv-lady-logo.jpg",
    "navbar": {
      "title": "Tech Vathiyaar",
      "logo": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Tech Vathiyaar."
    },
    "prism": {
      "theme": {
        "plain": {
